...
# $2 is -N if you want to not send the start plcfetch alarm code
$PLCFETCH_PATH $2 -q -v -D PLCFETCH -U plcfetch -P plcf3tch -I $(/sbin/ifconfig eth0 | grep "inet addr" | awk '{print $2}' | sed 's/addr\://g') 
