 ...
 *
 *		This file is part of the logserial package,
 *		Copyright 1998 Sinkovics Zoltan.
 *
 *		This file is part of the plcfetch package,
 *		Copyright 2006 Angelo Failla aka pallotron <pallotron@freaknet.org>
 *
